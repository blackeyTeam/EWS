...
import { reqInfo, Http } from "../api/api";
...
export default {
  ...
  methods: {
        changeLan(){
					 ...
					 this._i18n.locale=this.delivery==true?'EN':'CN';
				}
	}
};
</script>
...
.header-container {
  ...
  .header {
    ...
    background: linear-gradient(to right, #0081A8, #23BDDB); /* 标准的语法 */
    color: #fff;
    ...
    .toggleLang {
      ...
      float: right;
			...
			.el-form-item__label{color: #FFF!important;}
    }
    .logo {
      title {
        font-size: 18px;
