<template>
    ...
    <el-form-item style="width:100%;">
      <el-button type="primary" style="transform: translate(66%, 0px);" @click.native.prevent="handleSubmit2" :loading="logining">{{$t('Login')}}</el-button>
        ...
        this.$refs.ruleForm2.validate((valid) => {
          if (valid) {
           ...
           // requestLogin(loginParams).then(data => {
             ...
             reqInfo.requestLogin.headers = { 'Content-Type': 'multipart/form-data' }
             Http(reqInfo.requestLogin).then(data => {
              ...
              if (data) {
                ...
                this.$router.push({ path: '/systemUpate' });
              }
            });
          } else {
