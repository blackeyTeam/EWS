    ...
    export default {
        ...
        methods: {
            ...
            getInk() {
                ...
                !inkStatus?getHttp({url: reqInfo.inkLine.url}).then(res=>{
                          console.log(res)
...
<style>
 ...
 .lastLi{  border-bottom:1px solid #E9E9E9;}
 .inkLine li span{
	 float: right;
...
.red{color: rgb(255, 64, 129);;}
 .cyan{color: #00A6CE; background-color: #00A6CE;}
 .pinkish{color: rgb(255, 64, 129); background-color: rgb(255, 64, 129);}
.yellow{color: rgb(255, 230, 0); background-color: rgb(255, 230, 0);}
